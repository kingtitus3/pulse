  ...
  try {
    ...
    try {
      ...
      try {
        ...
        console.log('[ROOMS API] ✅ Prisma fallback found', rooms.length, 'rooms')
      } catch (prismaError: any) {
        console.error('[ROOMS API] Both Supabase and Prisma failed!')
        console.error('[ROOMS API] Prisma error:', prismaError.message)
        rooms = []
      }
    }
